...
DEPARTMENT_PROFILES: dict[str, dict] = {
    ...
    "산업부": {
        "coverage": (
            "대기업·중소기업, 통신, 에너지, 유통·물류, 건설·인프라, "
            "부동산 개발, ESG·탄소중립, 통상·무역"
        ),
        "criteria": [
            "기업 공식 발표: 실적, M&A, 대규모 투자·구조조정, 인사",
            "산업 정책: 정부 산업 지원책, 규제 변경, 통상·관세 조치",
            "시장 변동: 업계 판도 변화, 공급망 이슈, 대규모 계약·수주",
            "에너지·인프라: 전력·가스 수급, 건설 수주, 물류 재편",
        ],
        "report_keywords": [
            "대기업 실적", "M&A 인수합병", "통신 5G",
            "에너지", "유통 물류", "건설 인프라",
            "탄소중립 ESG", "통상 관세", "중소기업",
        ],
    },
    "테크부": {
        "coverage": (
            "IT·반도체·디스플레이, 배터리·2차전지, 자동차·모빌리티, "
            "AI·로봇, 바이오·제약, 스타트업·벤처, 핀테크, 클라우드·데이터센터"
        ),
        "criteria": [
            "기업 공식 발표: 실적, M&A, 대규모 투자·구조조정, 인사",
            "기술 동향: 신제품·신기술 출시, 기술 경쟁 구도 변화, 특허 분쟁",
            "산업 정책: 반도체·AI·바이오 등 정부 육성책, 규제 변경",
            "시장 변동: 업계 판도 변화, 공급망 이슈, 글로벌 기술 패권 경쟁",
            "스타트업: 대규모 투자 유치, IPO, 인수·합병, 주요 서비스 출시·종료",
        ],
        "report_keywords": [
            "반도체", "배터리 2차전지", "AI 인공지능",
            "자동차 산업", "바이오 제약", "스타트업",
            "로봇", "클라우드", "핀테크",
            "디스플레이", "모빌리티", "데이터센터",
        ],
