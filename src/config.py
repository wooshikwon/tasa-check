...
DEPARTMENT_PROFILES: dict[str, dict] = {
    "사회부": {
        "coverage": "사건·사고, 경찰·검찰 수사, 법원 재판, 인권, 재난·안전, 교육, 노동, 환경, 지방자치",
        "criteria": [
            "공식 수사 조치: 체포, 구속, 기소, 영장 청구/기각, 판결 선고",
            "중대 사건·사고: 사망, 대형 재난, 다수 피해자 발생",
            "수사 국면 전환: 소환→구속, 수사→기소, 1심→항소 등 단계 변화",
            "사회적 파장: 다수 언론 보도, 여론 형성, 후속 보도 가능성 높은 사안",
        ],
    },
    "정치부": {
        "coverage": "국회 입법, 정당 동향, 대통령실·행정부, 선거, 외교·안보, 남북관계, 헌법재판소",
        "criteria": [
    ...
    "경제부": {
        "coverage": "거시경제, 금융·통화 정책, 부동산, 세제·재정, 금융감독, 가계·소비 지표",
        "criteria": [
    ...
    "산업부": {
        "coverage": "대기업·중소기업, IT·반도체·배터리·자동차, 스타트업, 통신, 에너지, 유통·물류",
        "criteria": [
    ...
    "문화부": {
        "coverage": "문화·예술, 방송·미디어, 연예, 출판, 관광, 종교, 교육 정책, 문화재",
        "criteria": [
